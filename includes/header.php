            ...
            <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./ajoutRep.php">Link</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./question.php">Link</a>
                        </li>
                    </ul>
                </div>
                <button type="button" class="couleurP px-md-3 p-2 ">Se connecter</button>
            </nav>
        </div>